/**
 * @fuse/skideancer-ai-agent - AI Agent Widget
 * 
...
export class AIAgentWidget extends ReactWidget {
    ...
    static readonly LABEL = 'SkIDEancer Agent';
    ...
    protected init(): void {
        ...
        this.title.caption = 'SkIDEancer AI Assistant';
        ...
        this.agentService.onDidExecuteCapability(event => {
            console.log(`[SkIDEancerAgent] Capability executed: ${event.capability}`);
            this.update();
        });
                ...
                <div className="conversation-container">
                    {history.length === 0 ? (
                        <div className="welcome-message">
                            <h4>Welcome to SkIDEancer Agent!</h4>
