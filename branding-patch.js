...
function deepRebrand() {
    ...
    try {
        ...
        execSync(`find node_modules/@ide -type f -name "*.js" -exec sed -i "s/Eclipse SkIDEancer/SkIDEancer/g" {} +`);
        execSync(`find node_modules/@ide -type f -name "*.js" -exec sed -i "s/SkIDEancer Framework/SkIDEancer Core/g" {} +`);
        execSync(`find node_modules/@ide -type f -name "*.js" -exec sed -i "s/Welcome to SkIDEancer/Welcome to SkIDEancer/g" {} +`);
        execSync(`find node_modules/@ide -type f -name "*.js" -exec sed -i "s/Powered by SkIDEancer/Powered by TNF/g" {} +`);
        
        // Target specific phrases to avoid breaking technical terms
        execSync(`find node_modules/@ide -type f -name "*.js" -exec sed -i "s/about SkIDEancer/about SkIDEancer/g" {} +`);
        execSync(`find node_modules/@ide -type f -name "*.js" -exec sed -i "s/SkIDEancer is/SkIDEancer is/g" {} +`);
        
        // Aggressive replacement for labels (be careful)
        // execSync(`find node_modules/@ide -type f -name "*.js" -exec sed -i "s/SkIDEancer/SkIDEancer/g" {} +`);
